...
import { BADGE_GREEN, BADGE_ORANGE, BADGE_RED, BADGE_GRAY, type NormResult, sukmaSMM, sukmaBMI, sukmaFat, sukmaScore, sukmaFatMass, computeSkor, computeUlasan } from '../../../lib/inbodyNorms'
